...
With the flag set, the current clone **is** the worktree: write test files in
...
- The base-branch halt is unconditional. Never write test files on the base branch
